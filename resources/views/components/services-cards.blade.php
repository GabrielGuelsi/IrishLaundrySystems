...
<section class="py-16 lg:py-24 bg-white">
    <div class="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
        ...
        <div class="{{ $align === 'center' ? 'text-center mb-12 lg:mb-16 max-w-3xl mx-auto' : 'mb-10 lg:mb-12 max-w-3xl' }}">
            @if ($eyebrow)
            ...
            <p class="font-body {{ $align === 'center' ? 'text-gray-500' : 'text-gray-600' }} text-lg leading-relaxed">{{ $intro }}</p>
        </div>
            ...
            <a href="{{ $card['href'] }}"
               class="group relative overflow-hidden h-[480px] lg:h-[520px] rounded-2xl block cursor-pointer transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div class="absolute inset-0 p-6 lg:p-7 flex flex-col justify-end">
                    ...
                    <h3 class="font-heading font-bold text-white text-2xl lg:text-3xl leading-[1.05] tracking-tight drop-shadow-[0_4px_12px_rgba(0,0,0,0.45)] mb-4">{!! $card['title'] !!}</h3>

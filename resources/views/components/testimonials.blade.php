...
<section class="py-20 lg:py-28 {{ $light ? ('bg-[#f7f8fa]' . ($bordered ? ' border-y border-border' : '')) : 'bg-white' }}">
    <div class="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
        ...
        @if (! $single && ! empty($heading))
            <div class="text-center mb-14">
                ...
                @endif
                <h2 class="font-heading font-bold text-navy text-2xl sm:text-4xl lg:text-5xl leading-tight text-balance">{!! $heading !!}</h2>
                @if($subheading)

        ...
        <div class="border-2 border-navy rounded-b-xl bg-white shadow-card-hover overflow-hidden relative z-0">
            ...
            <div x-show="active === 'healthcare'"
                ...
                <div class="p-8 lg:p-10 bg-bg space-y-4">
                    ...
                    <a href="{{ route('service-contracts') }}" class="flex items-start gap-4 p-4 bg-white rounded-2xl border border-border hover:border-navy hover:shadow-card-hover transition-all duration-150 group">
                    ...
                    <a href="{{ route('repairs') }}" class="flex items-start gap-4 p-4 bg-white rounded-2xl border border-border hover:border-navy hover:shadow-card-hover transition-all duration-150 group">
                    ...
                    <a href="{{ route('equipment') }}" class="flex items-start gap-4 p-4 bg-white rounded-2xl border border-border hover:border-navy hover:shadow-card-hover transition-all duration-150 group">
            ...
            <div x-show="active === 'hospitality'" x-cloak
                ...
                <div class="p-8 lg:p-10 bg-bg space-y-4">
                    ...
                    <a href="{{ route('rental') }}" class="flex items-start gap-4 p-4 bg-white rounded-2xl border border-border hover:border-navy hover:shadow-card-hover transition-all duration-150 group">

...
<section class="py-16 lg:py-20 bg-white">
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        @endif
        <h2 class="font-heading font-bold text-navy text-2xl sm:text-3xl lg:text-5xl leading-tight text-balance text-center mb-3">{!! $heading !!}</h2>
        @if($subheading)
        ...
        <div class="space-y-3 max-w-3xl mx-auto" x-data="{ open: null }">
            ...
            <div class="bg-white border border-border rounded-2xl overflow-hidden shadow-card">
                <button
                    ...
                    aria-controls="faq-{{ $i }}">
                    <span class="font-heading font-bold text-navy text-base leading-snug">{{ $faq['question'] }}</span>

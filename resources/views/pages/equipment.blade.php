...
<section class="py-16 lg:py-24 bg-bg">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('equipment.category', 'washers') }}" class="group bg-white border border-border rounded-xl p-6 hover:border-navy hover:shadow-card-hover transition-all duration-200">
                <div class="w-12 h-12 rounded-xl bg-steel/10 flex items-center justify-center mb-4 group-hover:bg-steel/20 transition-colors">
            ...
            <a href="{{ route('equipment.category', 'dryers') }}" class="group bg-white border border-border rounded-xl p-6 hover:border-navy hover:shadow-card-hover transition-all duration-200">
                <div class="w-12 h-12 rounded-xl bg-orange/10 flex items-center justify-center mb-4 group-hover:bg-orange/20 transition-colors">
            ...
            <a href="{{ route('equipment.category', 'barrier-washers') }}" class="group bg-white border border-border rounded-xl p-6 hover:border-navy hover:shadow-card-hover transition-all duration-200">
            ...
            <a href="{{ route('equipment.category', 'ironers') }}" class="group bg-white border border-border rounded-xl p-6 hover:border-navy hover:shadow-card-hover transition-all duration-200">
                <div class="w-12 h-12 rounded-xl bg-navy/10 flex items-center justify-center mb-4 group-hover:bg-navy/20 transition-colors">
            ...
            <a href="{{ route('equipment.category', 'drying-cabinets') }}" class="group bg-white border border-border rounded-xl p-6 hover:border-navy hover:shadow-card-hover transition-all duration-200">

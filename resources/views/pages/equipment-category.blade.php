        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="lg:w-64 flex-shrink-0">
                <div class="bg-white border border-border rounded-2xl p-5 sticky top-24" x-data="{ typeOpen: true, capacityOpen: true, sectorOpen: true }">
                    <h3 class="font-heading font-bold text-navy text-base mb-4">Filter Equipment</h3>

                    <!-- Type filter -->
                    <div class="mb-4">
                        <button @click="typeOpen = !typeOpen" class="flex items-center justify-between w-full text-sm font-body font-bold text-navy mb-2 cursor-pointer">
                            Equipment Type
                    ...
                    <!-- Capacity filter -->
                    <div class="mb-4">
                        <button @click="capacityOpen = !capacityOpen" class="flex items-center justify-between w-full text-sm font-body font-bold text-navy mb-2 cursor-pointer">
                            Capacity
                    ...
                    <!-- Sector filter -->
                    <div>
                        <button @click="sectorOpen = !sectorOpen" class="flex items-center justify-between w-full text-sm font-body font-bold text-navy mb-2 cursor-pointer">
                            Sector
                    ...
                    <div class="mt-4 pt-4 border-t border-border">
                        <a href="{{ route('contact') }}" class="block w-full text-center bg-orange hover:bg-orange-dark text-white font-body font-bold px-4 py-2.5 rounded-lg text-sm transition-colors cursor-pointer">
                            Get a Quote
                        </a>
                    </div>
                </div>
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
                    ...
                    <a href="{{ route('equipment.product', [$categorySlug, $product->slug]) }}"
                       class="group bg-white border border-border rounded-2xl overflow-hidden hover:border-navy hover:shadow-card-hover transition-all duration-200">
                        ...
                        <div class="p-4">
                            ...
                            <span class="inline-flex items-center gap-1 text-steel text-xs font-body font-bold">
                    ...
                    <div class="col-span-3 text-center py-12">
                        <p class="font-body text-gray-500">No equipment available in this category yet. <a href="{{ route('contact') }}" class="text-steel font-bold hover:underline">Contact us</a> for availability.</p>
                    </div>
                    @endforelse
                </div>
                <div class="mt-8 text-center">
                    ...
                    <a href="{{ route('contact') }}"
                       class="inline-flex items-center gap-2 bg-navy hover:bg-navy-dark text-white font-body font-bold px-6 py-3 rounded-lg transition-colors cursor-pointer">
                        Talk to an Engineer
                    </a>
                </div>
            </div>

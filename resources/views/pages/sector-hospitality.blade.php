        ...
        <div class="max-w-7xl 2xl:max-w-[1600px] mx-auto w-full px-4 sm:px-6 lg:px-8 2xl:px-16 py-24 lg:py-32">
            <div class="max-w-5xl reveal reveal-left">
                ...
                <h1 class="font-heading font-bold text-navy text-3xl lg:text-5xl leading-tight mb-4">
                    Protect <span style="color:#148af4;">guest standards</span> when<br><span style="color:#6b7280;">linen flow</span>, housekeeping and<br>peak periods are under pressure
                </h1>
...
<section class="py-14 lg:py-20 bg-white">
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <p class="font-body text-gray-500 text-base mb-12 max-w-xl mx-auto leading-relaxed text-center">

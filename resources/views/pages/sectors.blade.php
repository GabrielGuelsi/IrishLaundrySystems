...
<section class="bg-navy py-20 lg:py-28">
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20 text-center">
        <h1 class="font-heading font-bold text-white text-4xl lg:text-6xl mb-5">Commercial Laundry Support by Sector</h1>
...
<section class="py-16 lg:py-20 bg-white">
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        <div class="text-center mb-10">
            <h2 class="font-heading font-bold text-navy text-4xl lg:text-5xl mb-4">How We Support Critical Operations</h2>
        </div>

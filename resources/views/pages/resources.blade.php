...
<section class="relative overflow-hidden py-20 lg:py-28"
    ...
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20 relative">
        ...
        {{-- Headline --}}
        <h1 class="font-heading font-bold text-white text-3xl sm:text-4xl lg:text-5xl text-center leading-tight mb-5 max-w-4xl mx-auto">
    ...
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            <div>
                ...
                <h2 class="font-heading font-bold text-navy text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-balance">Guides</h2>
    ...
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            <div>
                ...
                <h2 class="font-heading font-bold text-navy text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-balance">Checklists</h2>
...
<section class="py-14 lg:py-20"
    ...
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div class="text-center mb-12 reveal">
            ...
            <h2 class="font-heading font-bold text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-balance mb-3">Resources by machine type</h2>
        ...
        <div class="rounded-3xl overflow-hidden reveal" style="background:#f7f9fc; border:1px solid #e4eaf4;">
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="p-10 lg:p-16 flex flex-col justify-center">
                    ...
                    <h2 class="font-heading font-bold text-navy text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight text-balance mb-4">

    ...
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div class="mb-10 reveal">
            ...
            <h2 class="font-heading font-bold text-navy text-2xl sm:text-4xl lg:text-[2.3rem] 2xl:text-[2.8rem] leading-tight mb-3">
                Configure cabinet drying for<br class="hidden sm:block"><span style="color:#148af4;">garments, footwear</span><br class="hidden sm:block"><span style="color:#148af4;">and gloves</span>
            </h2>
            <p class="font-body text-gray-500 text-base leading-relaxed max-w-4xl">
                Choose accessories for the articles each<br class="hidden lg:block"> drying cabinet needs to accommodate.
            </p>
        </div>

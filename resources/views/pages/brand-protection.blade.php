        ...
        <div class="bg-white border border-border rounded-2xl p-6 sm:p-8 lg:p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="text-center p-4">
                    ...
                    <h3 class="font-heading font-bold text-navy text-sm mb-1">Service Contracts</h3>
                ...
                <div class="text-center p-4">
                    ...
                    <h3 class="font-heading font-bold text-navy text-sm mb-1">Repairs &amp; Call-outs</h3>
                ...
                <div class="text-center p-4">
                    ...
                    <h3 class="font-heading font-bold text-navy text-sm mb-1">Equipment &amp; Rental</h3>

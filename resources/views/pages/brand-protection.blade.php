        ...
        <div class="bg-white border border-border rounded-2xl p-8 lg:p-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="text-center p-4">
                    <div class="w-12 h-12 rounded-xl bg-steel/10 flex items-center justify-center mx-auto mb-3">
                ...
                <div class="text-center p-4">
                    <div class="w-12 h-12 rounded-xl bg-orange/10 flex items-center justify-center mx-auto mb-3">
                ...
                <div class="text-center p-4">
                    <div class="w-12 h-12 rounded-xl bg-navy/10 flex items-center justify-center mx-auto mb-3">

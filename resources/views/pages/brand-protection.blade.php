...
<section class="bg-navy py-20 lg:py-28">
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20 text-center">
        ...
        <h1 class="font-heading font-bold text-white text-2xl sm:text-4xl lg:text-5xl leading-tight text-balance mb-6">Irish Laundry Systems (ILS) — Official Website</h1>
...
<section class="py-20 lg:py-28 bg-bg">
    <div class="max-w-4xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div class="bg-white border border-border rounded-2xl p-6 sm:p-8 lg:p-10 mb-8">
            <h2 class="font-heading font-bold text-navy text-2xl sm:text-4xl lg:text-5xl mb-5">Disambiguation Statement</h2>
        ...
        <div class="bg-white border border-border rounded-2xl p-6 sm:p-8 lg:p-10 mb-8">
            <h2 class="font-heading font-bold text-navy text-2xl sm:text-4xl lg:text-5xl mb-5">How to Reach the Real ILS</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <div class="font-body font-bold text-navy text-sm mb-1">Coverage</div>
        ...
        <div class="bg-white border border-border rounded-2xl p-6 sm:p-8 lg:p-10">
            <h2 class="font-heading font-bold text-navy text-2xl sm:text-4xl lg:text-5xl mb-5">What Irish Laundry Systems Does</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div class="text-center p-4">
                    ...
                    <h3 class="font-heading font-bold text-navy text-xl mb-1">Service Contracts</h3>
                    <p class="font-body text-gray-600 text-sm leading-relaxed">Planned preventive maintenance and structured service support for commercial laundry operations.</p>
                </div>
                <div class="text-center p-4">
                    ...
                    <h3 class="font-heading font-bold text-navy text-xl mb-1">Repairs &amp; Call-Outs</h3>
                    <p class="font-body text-gray-600 text-sm leading-relaxed">Reactive breakdown repair and call-out support across the Republic of Ireland.</p>
                </div>
                <div class="text-center p-4">
                    ...
                    <h3 class="font-heading font-bold text-navy text-xl mb-1">Equipment &amp; Rental</h3>
                    <p class="font-body text-gray-600 text-sm leading-relaxed">Commercial laundry equipment supply, installation and rental/lease arrangements.</p>
                </div>
            </div>
        </div>
    </div>

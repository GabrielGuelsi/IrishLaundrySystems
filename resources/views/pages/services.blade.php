...
@include('components.services-cards', [
    ...
    'align'            => 'left',
    'cards'            => [
        ['title' => 'Repairs & Call-Outs',               'body' => 'Call-out and repair support when commercial laundry equipment needs to return to service.',                          'cta' => 'View Repairs & Call-Outs',              'href' => route('repairs'),           'img' => '/images/shared/repairs-callouts.webp',                'alt' => 'Repairs and Call-Outs',           'pos' => 'center 40%', 'bullets' => ['Fault review', 'Repair response', 'Service visit']],
        ['title' => 'Preventive Maintenance',  'body' => 'Planned inspections to protect equipment reliability and keep service records clear.',                               'cta' => 'View Preventive Maintenance',           'href' => route('service-contracts'), 'img' => '/images/shared/service-contracts-hero.webp',          'alt' => 'Preventive Maintenance',          'pos' => '80% center', 'bullets' => ['Planned checks', 'Service records', 'Maintenance control']],
        ['title' => 'Equipment Rental',                  'body' => 'Access selected Electrolux Professional laundry equipment without one large purchase.',                              'cta' => 'View Equipment Rental',                 'href' => route('rental'),            'img' => '/images/shared/td6-11-multihousing-room-front.webp', 'alt' => 'Equipment Rental',                'pos' => '66% center', 'bullets' => ['Lower upfront cost', 'Installed equipment', 'Included support']],
...
<section class="w-full overflow-hidden">
    <div style="display:flex; flex-wrap:wrap;">
        @foreach ([
            ['num' => '01.', 'title' => 'Share the service need', 'body' => 'Tell us what is happening with the equipment or what support your site requires.', 'img' => '/images/pages/services/services-how-01.webp'],
            ['num' => '02.', 'title' => 'Review the details',     'body' => 'We review the equipment, site requirements and any relevant service information.', 'img' => '/images/pages/services/services-how-02.webp'],
            ['num' => '03.', 'title' => 'Confirm the scope',      'body' => 'We clarify what support is required and what needs to be arranged next.', 'img' => '/images/shared/rentalstripimage.webp', 'pos' => '20% center'],
            ['num' => '04.', 'title' => 'Arrange the next step',  'body' => 'We confirm the appropriate visit, proposal, service action or follow-up for your enquiry.', 'img' => '/images/shared/service-contracts-hero.webp', 'pos' => '70% center'],
        ] as $card)

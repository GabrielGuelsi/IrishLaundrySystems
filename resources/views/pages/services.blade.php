...
<section class="py-16 lg:py-24 bg-white">
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="border-t-4 border-steel bg-bg rounded-2xl p-6 lg:p-8">
            ...
            <div class="border-t-4 border-orange bg-bg rounded-2xl p-6 lg:p-8">
            ...
            <div class="border-t-4 border-navy bg-bg rounded-2xl p-6 lg:p-8">
...
<section id="parts" class="py-16 lg:py-20 bg-bg">
    <div class="max-w-screen-2xl mx-auto px-6 sm:px-10 lg:px-20">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="bg-white border border-border rounded-2xl p-8 shadow-card">

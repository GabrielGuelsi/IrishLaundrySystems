...
@section('pageTitle', 'Reliable Commercial Laundry Systems & Service Since 1987 | Irish Laundry Systems')
@section('metaDescription', 'Contracts, repairs, parts and equipment — built around uptime. Request an assessment and we will confirm next steps and availability once we understand site details.')
...
<!-- 5. MID-PAGE DOWNTIME BLOCK (controlled, engineering-led) -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl">
            ...
            <h2 class="font-heading font-bold text-white text-3xl lg:text-4xl mb-5 leading-tight">
                Managing Downtime in Critical Laundry Operations
            </h2>
            <p class="font-body text-blue-200 text-xl leading-relaxed mb-8">
                Preventive service contracts designed to reduce operational risk in healthcare and regulated environments.
            </p>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                <div class="flex items-start gap-3">
                    <div class="w-8 h-8 rounded-full bg-orange/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg class="w-4 h-4 text-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    </div>
                    <div>
                        <p class="font-heading font-semibold text-white text-sm mb-1">Downtime risk</p>
                        <p class="font-body text-gray-400 text-sm leading-relaxed">Designed to reduce, not eliminate. Outcomes depend on site usage and conditions.</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="w-8 h-8 rounded-full bg-orange/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                        <p class="font-heading font-semibold text-white text-sm mb-1">Compliance & continuity</p>
                        <p class="font-body text-gray-400 text-sm leading-relaxed">Structured reporting and service records aligned to governance needs.</p>
                    </div>
                </div>
                <div class="flex items-start gap-3">
                    <div class="w-8 h-8 rounded-full bg-orange/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                        <p class="font-heading font-semibold text-white text-sm mb-1">Preventive maintenance</p>
                        <p class="font-body text-gray-400 text-sm leading-relaxed">Scheduled checks designed to catch issues early and extend equipment life.</p>
                    </div>
                </div>
            </div>
            <a href="{{ route('service-contracts') }}"
               class="inline-flex items-center gap-2 bg-orange hover:bg-orange-dark text-white font-body font-semibold px-7 py-3.5 rounded-lg text-base transition-colors duration-200 cursor-pointer">
                View Service Contracts
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/>
                </svg>

...
<section class="py-16 lg:py-24 bg-white">
    <div class="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
        ...
        <div class="mb-10 lg:mb-12 max-w-3xl">
            <p class="font-body font-bold text-orange text-xs uppercase tracking-[0.22em] mb-4">Services</p>
            ...
            <a href="{{ route($svc['route']) }}"
               class="group relative overflow-hidden h-[400px] lg:h-[440px] rounded-2xl block cursor-pointer transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <div class="absolute inset-0 p-6 flex flex-col justify-end">
                    ...
                    {{-- Title + CTA pill --}}
                    <h3 class="font-heading font-bold text-white text-2xl lg:text-3xl leading-[1.1] tracking-tight drop-shadow-[0_4px_12px_rgba(0,0,0,0.45)] mb-4">{{ $svc['title'] }}</h3>

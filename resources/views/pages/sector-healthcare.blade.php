...
<section class="py-10 bg-bg border-b border-border">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start reveal border-b border-border pb-8">
            <div>
                <h3 class="font-heading font-bold text-navy text-2xl lg:text-3xl mb-4">Maximise hygiene in healthcare applications</h3>
            ...
            <div class="lg:pt-2">
                ...
                <div class="flex items-center gap-5">
                    <img src="/images/healthcare/HygieneWatch_png.webp" alt="Hygiene Watchdog" class="w-24 h-24 object-contain flex-shrink-0">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start reveal border-b border-border pb-8">
            <div class="lg:pt-2">
                ...
                <div class="flex items-center gap-5">
                    <img src="/images/healthcare/AutoInner_png.webp" alt="Auto Inner Door Opening" class="w-24 h-24 object-contain flex-shrink-0">
                    <p class="font-body text-gray-600 text-base leading-relaxed">
            ...
            <div>
                <h3 class="font-heading font-bold text-navy text-2xl lg:text-3xl mb-4">Operator support in high-output laundries</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start reveal">
            <div>
                <h3 class="font-heading font-bold text-navy text-2xl lg:text-3xl mb-4">Intelligent control</h3>

...
Route::get('/preventive-maintenance', [PageController::class, 'serviceContracts'])->name('service-contracts');
Route::redirect('/service-contracts', '/preventive-maintenance', 301);
Route::get('/equipment-rental', [PageController::class, 'rental'])->name('rental');
Route::redirect('/rental', '/equipment-rental', 301);
Route::get('/repairs-call-outs', [PageController::class, 'repairs'])->name('repairs');
Route::get('/support-aftercare', [PageController::class, 'partsAftercare'])->name('parts-aftercare');
Route::redirect('/parts-aftercare', '/support-aftercare', 301);
